...
" Language keywords
syntax keyword torthKeywords BREAK DO DONE ELIF ELSE END ENDIF IF WHILE

syntax keyword torthFunctionDefs FUNCTION -- RET END
...
syntax keyword torthTypeNames array bool cstr int ptr str
